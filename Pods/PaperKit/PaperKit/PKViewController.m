...
//    _backgroundView = [[UIView alloc] initWithFrame:self.view.bounds];
    ...
    // Make collection view frame half of mainScreen height
    _backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height * 0.55)];
...
- (void)viewDidLoad {
    ...
    // Make collection view frame half of mainScreen height
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height * 0.55) collectionViewLayout:self.layout];
