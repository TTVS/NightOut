...
- (BOOL)canPerformAction:(SEL)action withSender:(id)sender {
    return (action == @selector(copyed:) || action == @selector(more:)) || action == @selector(transpond:) || action == @selector(favorites:);
}
...
//            timestampLabel.font = [UIFont systemFontOfSize:10.0f];
            timestampLabel.font = [UIFont fontWithName:@"AvenirNext-Regular" size:10.0f];
...
//            userNameLabel.font = [UIFont systemFontOfSize:12];
            userNameLabel.font = [UIFont fontWithName:@"AvenirNext-Regular" size:12.0f];
